...
do {                                                                          \
  ...
  const struct ConfigSection* s = config_section_find((conf), (section));     \
  if (!s) {                                                                   \
...
const struct ConfigSection* config_section_find(const struct RappConfig *conf, const char *section);
