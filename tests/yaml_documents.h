...
const char *yaml_no_section = ": {address: \"0.0.0.0\"}";
const char *yaml_no_section2 = "core: {address: \"0.0.0.0\"}, : {skipped: y}";
const char *yaml_no_section_name = "[1,2,3]: {address: \"0.0.0.0\"}";
const char *yaml_no_section_name2 = "core: {address: \"0.0.0.0\"}, [1,2,3]: {skipped: y}";
